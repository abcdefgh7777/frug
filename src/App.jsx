      ...
      <div className="container">
        ...
        <header className="header">
          ...
          <nav className="nav">
            ...
            <a href="https://x.com/bonkdafug" target="_blank" rel="noopener noreferrer" className="nav-img-link">
        ...
        <footer className="hero-footer">
          <p>
            ...
            <a href="https://x.com/bonkdafug" target="_blank" rel="noopener noreferrer" className="x-icon">
          ...
          <div className="cult-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="cult-content">
              ...
              <div className="cult-footer">
                ...
                <a href="https://x.com/bonkdafug" target="_blank" rel="noopener noreferrer" className="cult-x-link">
